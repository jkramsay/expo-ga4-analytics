Very stripped down fork of https://github.com/betaacid/expo-analytics

The intent was to update the calls from expo-analytics to support the GA4 measurements endpoints, but after a naive look at the GA4 endpoints and payloads it looks to only support custom events, so all other origin functionality in expo-analytics was stripped out. 
